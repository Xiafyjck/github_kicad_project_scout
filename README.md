...
- [x] Commit files for every commit event (stage 08, done 2026-09-03: 423293 commits, 469455 pages, 8.87M changed files, 45 GB), then rebuild stage 07 so commit events carry per-suffix file counts
- [ ] Publish a release
